...
'suf' is to generate only the graphs for log files having 'suf' suffix. 
'suf' must begin with one '_' character. If not specified, generate for all 
logfile found.
'extension' is the extension for the graphs ('png', 'eps' or 'jpg'). If not 
specified, is used 'png'.
